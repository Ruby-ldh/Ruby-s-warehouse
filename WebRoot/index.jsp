  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">到期列表</h1>
          </div><!-- /.col -->
          ...
          <div class="col-sm-6" style="float:right;">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">到期列表</li>
            </ol>
          </div><!-- /.col -->
    ...
    <tr>
    	<td>
    		<input type="text"  id="xmName" name="xmName" class="form-control"  value="${xmName }" placeholder="项目名称">
    	</td>
                  ...
                  <table class="table m-0">
                    <thead>
                                        <tr>
                                            ...
                                            <!--  -->
                                            <th class=" am-hide-sm-only">试用时长</th>
                                             <th class="table-set">试用码</th>
                                            <th class=" am-hide-sm-only">使用地点</th>
                                            <th class="table-title">设备类型</th>
                                            <th class=" am-hide-sm-only">是否授权</th>
                                            <th class=" am-hide-sm-only">操作系统</th>
                                    ...
                                    <c:forEach items="${findByOrdName }" var="list">
                                        <tr>
                                            ...
                                            <td>${list.type }</td>
                                            <td  class="am-hide-sm-only">${list.authorization }</td>
