...
request.getRequestDispatcher("findEquipmentBeanId.do?ordId="+ordId+"&xmName="+xmName).forward(request, response);
%>

		
	<div>立 即 <a href="findEquipmentBeanId.do?ordId=${ordId }&xmName=${xmName}"> 跳 转 ,</a> <span id="index">3</span> 自 动 跳 转 ！！！</div>
</body>
<script type="text/javascript">
	window.onload=function(){
		...
		setTimeout(function jump(){
			window.location.href="findEquipmentBeanId.do?ordId=${ordId }&xmName=${xmName}";
		}, 1000);
	}
</script>
</html>